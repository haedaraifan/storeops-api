...
Route::middleware(ApiAuthMiddleware::class)->group(function() {
    ...
    Route::middleware("role:Admin")->group(function() {
        ...
        Route::post("/products/{productId}/adjust", [ProductController::class, "adjust"])->where("productId", "[0-9]+");
    ...
    Route::get("/products/recap/{productId}", [ProductController::class, "detailRecap"])->where("productId", "[0-9]+");
